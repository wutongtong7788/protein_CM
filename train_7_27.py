...
def main():
    ...
    path_train_dismap = './examples/train_dismap_20_hdf5_file.h5'
    path_test = './examples/test.fasta'
    path_test_repre = './examples/test_hdf5_file.h5'
    path_test_label = './examples/test_label_hdf5_file.h5'
    path_test_contact = './examples/test_contact_hdf5_file.h5'
    path_test_dismap = './examples/test_dismap_20_hdf5_file.h5'
    ...
    test = Dataset(path_test, test_h5fi_repre,test_h5fi_label,test_h5fi_contact,test_h5fi_dismap,flag=0)
...
#############测试
        ...
        with torch.no_grad():
            ...
            T10 = float(T10)
            L30 = float(L30)
            print('[epoch:%d] val_loss: %.06f| T10: %.03f' % (epoch + 1, val_loss_epoch, T10))
            print('[epoch:%d] val_loss: %.06f| L10: %.03f' % (epoch + 1, val_loss_epoch, L30))
